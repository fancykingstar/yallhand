      ...
      <div className="Segment">
        ...
        <Segment>
          ...
          <Form.Group inline widths="equal" style={{ paddingRight: 10 }}>
            ...
            <Form.Select fluid label="Team(s) Access" placeholder="dropdown" />
            <Form.Select fluid label="Channel(s) Access" placeholder="dropdown" />
            <Form.Select fluid label="Class" placeholder="dropdown" />  
            <Form.Button style={{ marginTop: 24 }} icon="plus" />
          </Form.Group>
          <Form.Group widths='equal'>
            
            <Popup trigger={<Form.Radio toggle active={active} onClick={this.handleClick} label="All Access"/>} content='Complete account access to all teams, channels, users, and settings' />
          </Form.Group>
        </Form>
...
<Table style={{maxWidth: 850}} basic="very">
          ...
          <Table.Body>
            <Table.Row>
              ...
              <Table.HeaderCell><Icon name="minus circle"/></Table.HeaderCell>
            </Table.Row>
